...
return [
    ...
    "this table is reservated at this time"=>"this table is reservated at this time",
    "the reservation was created successfully and you need to continue the reservation by payment"=>"the reservation was created successfully and you need to continue the reservation by payment",
    "table id is not exists"=>"table id is not exists",
    "table id is required"=>"table id is required",
    "the start date is required"=>"the start date is required",
    "the end date is required"=>"the end date is required",
    "the end date should be greater from start date"=>"the end date should be greater from start date",
    "payment id is required"=>"payment id is required",
    "we have error"=>"we have error",
    "payment method is not correct"=>"payment method is not correct",
    "the start date should be after now"=>"the start date should be after now",
    "client id is required"=>"client id is required",
    "secret is required"=>"secret is required",
    "the information about paypal setting was updated successfully"=>"the information about paypal setting was updated successfully",
    "name is required"=>"name is required",
    "the reservation was updated successfully and you need to continue the reservation by payment"=>"the reservation was updated successfully and you need to continue the reservation by payment",
    "the reservation name was updated successfully"=>"the reservation name was updated successfully",
