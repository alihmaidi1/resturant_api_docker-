...
return [
    ...
    "this table is reservated at this time"=>"هذه الطاولة محجوزة في هذا الوقت",
    "the reservation was created successfully and you need to continue the reservation by payment"=>"تم انشاء الحجز بنجاح ولكن يجب تثبيته عن طريق الدفع",
    "table id is not exists"=>"معرف الطاولة غير موجود",
    "table id is required"=>"معرف الطاولة مطلوب",
    "the start date is required"=>"تاريخ بداية الحجز مطلوب",
    "the end date is required"=>"تاريخ نهاية الحجز مطلوب",
    "the end date should be greater from start date"=>"تاريخ النهاية يجب أن يكون أكبر من تاريخ البداية",
    "payment id is required"=>"وسيلة الدفع مطلوبة",
    "we have error"=>"يوجد خطأ ما",
    "payment method is not correct"=>"بوابة الدفع هذه غير صحيحة",
    "the start date should be after now"=>"تاريخ بدء الحجز يجب أن  يكون من أو بعد هذه اللحظة",
    "client id is required"=>"معرف الكلينت مطلوب",
    "secret is required"=>"الكلمة السرية مطلوبة",
    "the information about paypal setting was updated successfully"=>"تم تعديل اعدادات حساب دفع بايبال",
    "name is required"=>"الاسم مطلوب",
    "the reservation was updated successfully and you need to continue the reservation by payment"=>"تم تعديل معلومات الحجز بنجاح",
    "the reservation name was updated successfully"=>"تم تعديل اسم الحجز بنجاح",
